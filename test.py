from our_library import our_classes_and_functions
import numpy as np
...
our_classes_and_functions.Bird.get_neighbors 
...
def retrieve_param_eta(eta,it,N,V, L, R, interaction_radius_1, interaction_radius_2, interaction_radius_3):
    swarm = our_classes_and_functions.Swarm(L, N, V, eta, R)
    #swarm = myfunctions.Swarm(L, N, V, eta, interaction_radius_1, interaction_radius_2, interaction_radius_3)
    swarm.initialize()
